...
class DataLoaderMouse():
    ...
    def __init__(self, batch_size=50, seq_length=5,forcePreProcess=False, infer=False, body_keypoint:list = None,train_frac = 0.0625,val_fraction=0.3,\
                 skip_frames_by_static = 'Slice',normalise = True,frames = 100):
        '''
    ...
    def revert_seq(self,sequence):
        return sequence[...,[0,1]]*self.max_x
    def convert_seq(self,sequence):
        return ((sequence[...,[0,1]]/self.max_x)*2)-1

    
    def frame_preprocess(self,data_file,thresh=100,skip = 20):
        '''
