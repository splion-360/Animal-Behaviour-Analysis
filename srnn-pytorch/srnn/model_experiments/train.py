...
def main():
    ...
    parser.add_argument(
        "--exp_name", type=str, help="Name of the run", default="exp",
    )
...
def train(args):
    ...
    dataloader = DataLoaderMouse(args.batch_size, args.seq_length + 1, forcePreProcess=True,body_keypoint=args.body_keypoint,\
                                 train_frac=args.train_frac,train_data=args.train,skip_frames_by_static=None, allkp=args.all_kp, frames = 120)
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in range(dataloader.num_batches):
            ...
            # logger.info(
            #     '{}/{} (epoch {}),Gaussian Loss = {:.3f}, Geodesic Loss = {:.3f} ,batch_train_loss = {:.3f}, time/batch = {:.3f}'.format(epoch * dataloader.num_batches + batch,
